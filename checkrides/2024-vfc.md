...
Extend downwind and right-hand orbit over the water.
...
What is the purpose of the "four corners check" during your pre-start pre-flight checks? (FTGU p288)

Check that the control surfaces (ailerons, elevators, rudder) are responding in the proper direction of travel. It is not unheard of for the controls to be reinstalled in reverse during maintenance.
...
An heavy plane will impact everything connected with lift: takeoff runs, angle of climb, rate of climb, stall speeds.

An aft CG makes the plane less stable, making recovory from maneuvers more difficult.
