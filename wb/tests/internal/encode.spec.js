...
let fs = require('fs');
let decodeFlight = new Function(
    fs.readFileSync('./assets/encoding.js').toString() +
        ' return decodeFlight;',
)();
let encodeFlight = new Function(
    fs.readFileSync('./assets/encoding.js').toString() +
        ' return encodeFlight;',
)();
...
describe('Encode/Decode', () => {
    ...
    it('is provided by window', () => {
        ...
        let expected =
            'eyJwbGFuZSI6IkNHU0RaIiwiZnJvbnRzZWF0LTEiOiIxODAiLCJmcm9udHNlYXQtMiI6IjExMCIsImJhY2tzZWF0LTEiOiIxMjAiLCJiYWNrc2VhdC0yIjoiMTMwIiwiZ2FsbG9ucyI6IjMwIiwidGFuayI6IjE4MCIsImJhZ2dhZ2UxIjoiNTUiLCJiYWdnYWdlMiI6IjI1In0=';
    ...
    it('needs to resist almost good query string, but no', () => {
        let search =
            '?before=stuff&flight=eyJwbGFuZSI6IkNHU0RaIn0=&after=stuff';
        let flight = decodeFlight(search, window);
